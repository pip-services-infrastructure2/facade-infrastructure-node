...
```javascript
{
    ...
    "dependencies": {
        ...
        "facade-infrastructure-node": "^1.0.*",
        ...
    }
}
```
...
```typescript
import { LoggingOperations } from 'facade-infrastructure-node';
...
let references = References.fromTuples(
    new Descriptor('service-logging', 'client', 'http', 'default', '1.0'), loggingClient
);
